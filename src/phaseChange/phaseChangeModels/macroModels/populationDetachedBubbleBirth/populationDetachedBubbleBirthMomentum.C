/*---------------------------------------------------------------------------*\
    Optional coarse-grid departure momentum closure for persistent-population boiling
\*---------------------------------------------------------------------------*/
...
void Foam::populationDetachedBubbleBirth::momentumSource
(
    fvVectorMatrix& UEqn
)
{
