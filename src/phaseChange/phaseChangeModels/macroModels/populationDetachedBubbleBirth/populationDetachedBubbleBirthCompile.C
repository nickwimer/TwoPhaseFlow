/*---------------------------------------------------------------------------*\
    Build wrapper for populationDetachedBubbleBirth.
...
template<class Type>
inline void populationSiteStencilReduceDiagnostic
(
    const char* name,
    const Type& value
)
{
    ...
    {
        Foam::Info<< "POPULATION_SITE_STENCIL_DIAGNOSTIC "
...
extern "C++"
{
#include "populationDetachedBubbleBirth.C"
